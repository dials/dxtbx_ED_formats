...
class FormatCBFGatanOneView(FormatCBF):
  ...
  def understand(image_file):
    ...
    if 'data_clip:_flipx' not in header: return False
    if '_array_data.header_convention' in header: return False
    if 'Detector' in header: return False
  ...
  def read_cbf_image(self, cbf_image):
    ...
    if byte_offset:
      ...
      raise ValueError("Uncompression of type other than byte_offset or none "
